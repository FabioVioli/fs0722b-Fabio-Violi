let myTuple = [10, "Wello", "World", "TypeScript"]; // i tipi vengono dedotti in automatico ( non sarà possibile aggiungere altri valori al di fuori di stringhe e numeri )
